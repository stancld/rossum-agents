...
from rossum_mcp.tools.users import _get_user, _list_user_roles, _list_users, register_user_tools
...
class TestListUsers:
    ...
    @pytest.mark.asyncio
    async def test_list_users_with_username_filter(self, mock_client: AsyncMock) -> None:
        ...
        result = await _list_users(mock_client, username="specific.user@example.com")

        assert len(result) == 1
        assert received_filters["username"] == "specific.user@example.com"

    @pytest.mark.asyncio
    async def test_list_users_with_email_filter(self, mock_client: AsyncMock) -> None:
        ...
        result = await _list_users(mock_client, email="test@example.com")

        assert len(result) == 1
        assert received_filters["email"] == "test@example.com"

    @pytest.mark.asyncio
    async def test_list_users_with_is_active_filter(self, mock_client: AsyncMock) -> None:
        ...
        result = await _list_users(mock_client, is_active=True)

        assert len(result) == 1
        assert received_filters["is_active"] is True

    @pytest.mark.asyncio
    async def test_list_users_empty_result(self, mock_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_users_with_multiple_filters(self, mock_client: AsyncMock) -> None:
        ...
        result = await _list_users(mock_client, first_name="John", last_name="Doe")
    ...
    @pytest.mark.asyncio
    async def test_list_users_filter_is_organization_group_admin_true(self, mock_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_users_filter_is_organization_group_admin_false(self, mock_client: AsyncMock) -> None:
        ...
        result = await _list_users(mock_client, is_organization_group_admin=False)
    ...
    @pytest.mark.asyncio
    async def test_list_users_filter_is_organization_group_admin_no_admins(self, mock_client: AsyncMock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_users_skips_broken_items(self, mock_client: AsyncMock) -> None:
...
class TestListUserRoles:
    ...
    @pytest.mark.asyncio
    async def test_list_user_roles_success(self, mock_client: AsyncMock) -> None:
