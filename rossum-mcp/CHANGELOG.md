...
- Removed `create_queue` tool — not suitable for agent use; use `create_queue_from_template` instead [#232](https://github.com/stancld/rossum-agents/pull/232)
- Removed `update_schema` tool — not suitable for agent use; use `patch_schema` for field-level updates [#232](https://github.com/stancld/rossum-agents/pull/232)
