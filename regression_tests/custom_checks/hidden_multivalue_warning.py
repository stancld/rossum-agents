"""Check that knowledge base warns about hidden/multivalue datapoint requirements."""
...
_PROMPT = """Analyze the following knowledge base search result about document splitting.
...
def check_knowledge_base_hidden_multivalue_warning(
    ...
    for step in steps:
        for tr in step.tool_results:
            ...
            return call_haiku_check(_PROMPT.format(analysis=analysis[:8000]))
