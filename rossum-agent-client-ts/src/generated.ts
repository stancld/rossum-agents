...
export interface components {
    schemas: {
        ...
        StepEvent: {
             ...
             * @enum {string}
             */
            type: "thinking" | "intermediate" | "tool_start" | "tool_result" | "final_answer" | "error";
            /** Step Number */
            step_number: number;
            /**
             * Content
        ...
        SubAgentProgressEvent: {
             ...
             * @enum {string}
             */
            status: "thinking" | "searching" | "analyzing" | "reasoning" | "running_tool" | "completed" | "running";
        };
        /**
         * SubAgentTextEvent
        ...
        StreamDoneEvent: {
            ...
            cache_read_input_tokens: number;
            /** @default null */
            token_usage_breakdown: components["schemas"]["TokenUsageBreakdown"] | null;
            /**
             * Config Commit Hash
             * @default null
             */
         ...
         */
        SSEEvent: components["schemas"]["StepEvent"] | components["schemas"]["SubAgentProgressEvent"] | components["schemas"]["SubAgentTextEvent"] | components["schemas"]["TaskSnapshotEvent"] | components["schemas"]["AgentQuestionEvent"] | components["schemas"]["FileCreatedEvent"] | components["schemas"]["StreamDoneEvent"];
    };
    responses: never;
    parameters: never;
    requestBodies: never;
...
export interface operations {
    ...
    report_to_slack_api_v1_chats__chat_id__report_to_slack_post: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["ReportToSlackRequest"] | null;
            };
        };
        responses: {
            /** @description Successful Response */
