...
class TestConfigCommit:
    ...
    def test_to_dict(self):
        ...
        assert result["timestamp"] == "2025-02-13T12:00:00+00:00"
    ...
    def test_from_dict(self):
        ...
        commit = ConfigCommit.from_dict(data)
    ...
    def test_roundtrip(self):
        ...
        restored = ConfigCommit.from_dict(data)
    ...
    def test_from_dict_with_no_changes(self):
        data = {
            "hash": "abc123",
            "chat_id": "chat_1",
            "timestamp": "2025-02-13T12:00:00+00:00",
