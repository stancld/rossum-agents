...
**Skills:**
- `load_skill` - Load domain-specific workflows (`rossum-deployment`, `hook-debugging`, `schema-patching`, `schema-pruning`, `organization-setup`, `schema-creation`, `ui-settings`, `rules-and-actions`)
