...
|------------|-------------|
| **Rossum MCP Integration** | Full access to 68 MCP tools for document processing |
...
The agent provides internal tools and access to 68 MCP tools via dynamic loading.
